  ...
  const { steps, currentStepIndex, step, isFirstStep, isLastStep, back, next } =
    useMultiSteps([
      ...
      <article>
        ...
        <p className="signup-details-finePrint">
          Please take a moment to make sure all of your information is correct.
        </p>
    ...
    <IonPage>
      <IonContent fullscreen>
        ...
        <section className="signup-form-container">
          ...
          {!isFirstStep && (
            <Button hasIcon={true} iconName={arrowBackOutline} onClick={back} />
          )}
          <form action="">{step}</form>
          {isLastStep ? (
            <Button btnText="Finish" onClick={next} />
          ) : (
