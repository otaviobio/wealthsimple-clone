...
const coinsData = [
  {
    ...
    coins: [
      ...
      {
        UUID: "MoTuySvg7",
        iconUrl: "https://cdn.coinranking.com/mAZ_7LwOE/mutli-collateral-dai.svg?size=34x34",
        name: "DAI",
        symbol: "DAI",
        change: 0.07
      },
  ...
  },
  {
    ...
    coins: [
      ...
      {
        UUID: "ncYFcP709",
        iconUrl: "https://cdn.coinranking.com/aRtgdw7bQ/pancakeswap-cake-logo.png?size=30x30",
        name: "PancakeSwap",
        symbol: "CAKE",
        change: 1.62
      },
  ...
  },
  {
    ...
    coins: [
      {
        UUID: "tEf7-dnwV3BXS",
        iconUrl: "https://cdn.coinranking.com/ph_svUzXs/decentraland(1).svg?size=30x30",
        name: "Decentraland",
        symbol: "MANA",
        change: 1.42
      },
      ...
      {
        UUID: "gpRKmM16k",
        iconUrl: "https://cdn.coinranking.com/L3gWtlUJB/axie-infinity.png?size=30x30",
        name: "Axie Infinity",
        symbol: "AXS",
        change: -1.35
      },
